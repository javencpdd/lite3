...
> 生成时间：2026-09-24 · 目标主机：`ysc@192.168.1.103` · 目录：`/home/test`
...
scp "$SRC/readme"                 ysc@192.168.1.103:/home/test/readme
scp "$SRC/.gitignore"             ysc@192.168.1.103:/home/test/.gitignore
scp "$SRC/DRYRUN-变更预演清单.md" ysc@192.168.1.103:/home/test/
scp -r "$SRC/note/."              ysc@192.168.1.103:/home/test/note/
...
（`note/05` 与各部署文档含 `192.168.x`、`172.31.68.227` 等内网信息）。
