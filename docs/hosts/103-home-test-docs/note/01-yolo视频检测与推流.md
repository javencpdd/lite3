...
rtsp://192.168.1.120:8554/test
  ...
  → 标注帧 640×360
  ├─ RTMP  rtmp://172.31.68.227:1936/live/lite3_yolo
...
| `YOLO8_RTMP_URL` | `rtmp://172.31.68.227:1936/live/lite3_yolo` | 推流地址 |
...
curl -sL http://172.31.68.227:1985/api/v1/streams/             # SRS 流列表（必须 -L），看 lite3_yolo 是否 active
```
