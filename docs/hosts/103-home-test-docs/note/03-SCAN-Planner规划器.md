...
```bash
export https_proxy=http://192.168.2.47:7897 http_proxy=http://192.168.2.47:7897
...
| 现象 | 原因 | 处理 |
|---|---|---|
| `git clone` 卡死 | 103 直连 GitHub TCP 443 超时 | 走代理 `http://192.168.2.47:7897` 或 gh-proxy 镜像 |
